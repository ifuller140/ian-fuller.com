...
I was tasked with the challenge of designing, building and coding an autonomous robot to complete 4 core objectives:
...
![Fire Truck](/fire-truck/fire-truck.jpg)

## Topography Sensing

![Topography Orientations](/fire-truck/topography.png)
...
![Front View](/fire-truck/suppression-nodes.png)
...
![Fire Suppression GIF](/fire-truck/preview.gif)
...
This is the action based flow desicsion tree that carried the logic to completing the sensing portion of this mission. The code was written in Arduino.
